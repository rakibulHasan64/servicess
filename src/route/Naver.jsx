...
function Navbar() {
   ...
   const [darkMode, setDarkMode] = useState(() => {
      return localStorage.getItem("darkMode") === "true";  // রিলোড দিলেও ডাটা থাকবে
   });
               ...
               <div className="hidden md:flex space-x-9">
                  ...
                  {user && (
                     <div className="relative">
                        ...
                        <ul className={`absolute shadow-lg bg-white space-y-3 top-full left-0 min-w-[250px] z-50 px-6 pb-4 pt-6 transition-all duration-500 ${isDropdownOpen ? "block" : "hidden"}`}>
                           ...
                           <li><Link to="/blog" className="block py-2 text-gray-600">Blog</Link></li>
                        </ul>
                     </div>
                  )}
                  ...
                  <div className="relative">
                     ...
                     {isDropdownOpen && (
                        <ul className="absolute shadow-lg bg-white space-y-3 top-5 -left-6 min-w-[250px] z-50  px-6 pb-4 pt-6 transition-all duration-500 ease-in-out">
                           ...
                           <li>
                              <Link to="/blog" className="block py-2 hover:text-[#007bff] text-gray-600">
                                 Blog
                              </Link>
                           </li>
                        </ul>
