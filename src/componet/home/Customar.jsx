...
function Customar() {
   ...
   return (
      <div className="bg-[#F5F9FF] dark:bg-gray-600 shadow-2xl p-4">
         <div className="container mx-auto py-20">
            ...
            {/* Sub-header */}
            <h3 className="text-[45px] text-center mt-10 dark:text-white" data-aos="fade-up" data-aos-delay="200">
                  ...
                  {[
                     ...
                     >
                        ...
                        <button
                           ...
                           className={`w-full text-xl  sm:text-2xl  text-left font-semibold ${activeIndex === index ? "text-blue-600" : "text-gray-800"
                              } flex items-center transition-all`}
                        >
                           <span className="mr-4">{question}</span>
                           <span
                              className={`ml-auto text-xl  sm:text-2xl font-bold transition-transform ${activeIndex === index ? "rotate-0" : "rotate-45"
                                 }`}
                           >
                              {activeIndex === index ? "-" : "+"}
                           </span>
                        ...
                        {/* Accordion Content */}
                        <div
                           className={`mt-3 text-lg sm:text-xl text-gray-600 leading-relaxed transition-all ${activeIndex === index ? "block" : "hidden"
                              }`}
                        >
