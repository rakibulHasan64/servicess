...
function MyRequest() {
   ...
   if (error) return <p className="text-center text-red-500">Failed to load requests</p>;
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                           {requests.map((request) => (
                              <tr key={request._id}>
                                 ...
                                 <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">${request.price}</td>
                                 <td className="px-4 py-4 text-sm whitespace-nowrap">
                                    <p className="px-3 py-1 text-xs text-blue-500 bg-blue-100 rounded-full">{request.serviceName}</p>
                                 </td>
                                 <td className="px-4 py-4 text-sm text-yellow-500 whitespace-nowrap">
                                    <span className="px-3 py-1 text-xs bg-yellow-100 rounded-full">{request.status}</span>
                                 </td>
                                 <td className="px-4 py-4 text-sm whitespace-nowrap">
                                    <button
                                       title="Mark Complete"
